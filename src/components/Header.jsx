    ...
    return (
        <header className="text-white p-8">
            ...
            <div className="flex items-center justify-between  mx-auto">
                {/* Logo */}
                <a href="/"><div className="flex-shrink-0 text-5xl font-extrabold flex items-center select-none">
                    <span className="text-white drop-shadow-md">AV</span>
                    <span className="ml-1 text-transparent bg-clip-text bg-gradient-to-r 
                ...
                <div className="hidden md:flex flex-shrink-0 w-[470px] h-[60px] 
            ...
            <nav className="hidden md:block mt-10 w-full">
                <ul className="flex flex-nowrap px-2 md:px-0 space-x-4 md:space-x-6 
